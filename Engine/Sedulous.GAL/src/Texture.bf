...
namespace Sedulous.GAL
{
    ...
    public abstract class Texture : DeviceResource, MappableResource, IDisposable, BindableResource
    {
        ...
        public uint32 CalculateSubresource(uint32 mipLevel, uint32 arrayLayer)
        {
        ...
        internal protected virtual TextureView CreateFullTextureView(GraphicsDevice gd)
        {
        ...
        internal protected abstract void DisposeCore();
    }
}
