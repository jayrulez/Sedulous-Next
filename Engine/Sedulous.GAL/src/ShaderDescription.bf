...
namespace Sedulous.GAL
{
    ...
    public struct ShaderDescription : IEquatable<ShaderDescription>
    {
        ...
        public this(ShaderStages stage, Span<uint8> shaderBytes, String entryPoint)
        {
            Stage = stage;
        ...
        public this(ShaderStages stage, Span<uint8> shaderBytes, String entryPoint, bool debug)
        {
            Stage = stage;
            ShaderBytes = shaderBytes;
            EntryPoint = entryPoint;
        ...
        public int GetHashCode()
        {
			...
			hash = HashHelper.Combine(hash, (int)(void*)ShaderBytes.Ptr);

            return HashHelper.Combine(hash,
