...
namespace Sedulous.GAL
{
    ...
    {
        internal this(GraphicsPipelineDescription graphicsDescription)
        ...
        internal this(ComputePipelineDescription computeDescription)
            : this(computeDescription.ResourceLayouts)
        { }

        internal this(Span<ResourceLayout> resourceLayouts)
        {
#if VALIDATE_USAGE
            ResourceLayouts = new .();
			ResourceLayouts.AddRange(resourceLayouts);
#endif
        }
        ...
        internal List<ResourceLayout> ResourceLayouts { get; } ~ delete _;
#endif
    }
}
