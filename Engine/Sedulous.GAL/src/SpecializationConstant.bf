...
namespace Sedulous.GAL
{
    ...
    public struct SpecializationConstant : IEquatable<SpecializationConstant>, IHashable
    {
        ...
        /// <summary>
        /// An 8-uint8 block storing the contents of the specialization value. This is treated as an untyped buffer and is
        ...
        /// <param name="data">An 8-uint8 block storing the contents of the specialization value. This is treated as an untyped
        /// buffer and is interepreted according to <see cref="Type"/>.</param>
        public this(uint32 id, ShaderConstantType type, uint64 data)
        {
            ID = id;
            Type = type;
            Data = data;
        ...
        public this(uint32 id, bool value) : this(id, ShaderConstantType.Bool, Store(value ? (uint8)1u : (uint8)0u)) { }
        /// <summary>
        /// Constructs a new <see cref="SpecializationConstant"/> for a 16-bit unsigned integer.
        /// </summary>
        /// <param name="id">The constant variable ID.</param>
        /// <param name="value">The constant value.</param>
        public this(uint32 id, uint16 value) : this(id, ShaderConstantType.UInt16, Store(value)) { }
        /// <summary>
        /// Constructs a new <see cref="SpecializationConstant"/> for a 16-bit signed integer.
        /// </summary>
        /// <param name="id">The constant variable ID.</param>
        /// <param name="value">The constant value.</param>
        public this(uint32 id, int16 value) : this(id, ShaderConstantType.Int16, Store(value)) { }
        /// <summary>
        /// Constructs a new <see cref="SpecializationConstant"/> for a 32-bit unsigned integer.
        /// </summary>
        /// <param name="id">The constant variable ID.</param>
        /// <param name="value">The constant value.</param>
        public this(uint32 id, uint32 value) : this(id, ShaderConstantType.UInt32, Store(value)) { }
        /// <summary>
        /// Constructs a new <see cref="SpecializationConstant"/> for a 32-bit signed integer.
        /// </summary>
        /// <param name="id">The constant variable ID.</param>
        /// <param name="value">The constant value.</param>
        public this(uint32 id, int32 value) : this(id, ShaderConstantType.Int32, Store(value)) { }
        /// <summary>
        /// Constructs a new <see cref="SpecializationConstant"/> for a 64-bit unsigned integer.
        /// </summary>
        /// <param name="id">The constant variable ID.</param>
        /// <param name="value">The constant value.</param>
        public this(uint32 id, uint64 value) : this(id, ShaderConstantType.UInt64, Store(value)) { }
        /// <summary>
        /// Constructs a new <see cref="SpecializationConstant"/> for a 64-bit signed integer.
        /// </summary>
        /// <param name="id">The constant variable ID.</param>
        /// <param name="value">The constant value.</param>
        public this(uint32 id, int64 value) : this(id, ShaderConstantType.Int64, Store(value)) { }
        /// <summary>
        /// Constructs a new <see cref="SpecializationConstant"/> for a 32-bit floating-point value.
        /// </summary>
        /// <param name="id">The constant variable ID.</param>
        /// <param name="value">The constant value.</param>
        public this(uint32 id, float value) : this(id, ShaderConstantType.Float, Store(value)) { }
        /// <summary>
        /// Constructs a new <see cref="SpecializationConstant"/> for a 64-bit floating-point value.
        /// </summary>
        /// <param name="id">The constant variable ID.</param>
        /// <param name="value">The constant value.</param>
        public this(uint32 id, double value) : this(id, ShaderConstantType.Double, Store(value)) { }

        internal static uint64 Store<T>(in T value)
        {
            uint64 ret = 0;
			Internal.MemCpy(&ret, &value, sizeof(T));
            return ret;
        }
