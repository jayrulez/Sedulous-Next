...
namespace Sedulous.Graphics.VertexFormats
{
	...
	public struct VertexPositionNormalTangentColorDualTexture
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionNormalTangentColorDualTexture" /> struct.
		/// </summary>
		...
		/// <summary>
		/// Initializes static members of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionNormalTangentColorDualTexture" /> struct.
		/// </summary>
		static this()
		{
			VertexFormat = new LayoutDescription()
				...
				.Add(ElementDescription(ElementFormat.Float2, ElementSemanticType.TexCoord, 1u));
		}
