...
namespace Sedulous.Graphics.VertexFormats
{
	...
	public struct VertexPositionColor
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionColor" /> struct.
		/// </summary>
		...
		/// <summary>
		/// Initializes static members of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionColor" /> struct.
		/// </summary>
		static this()
		{
