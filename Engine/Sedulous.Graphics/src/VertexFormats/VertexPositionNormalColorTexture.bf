...
namespace Sedulous.Graphics.VertexFormats
{
	...
	public struct VertexPositionNormalColorTexture
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionNormalColorTexture" /> struct.
		/// </summary>
		...
		/// <summary>
		/// Initializes static members of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionNormalColorTexture" /> struct.
		/// </summary>
		static this()
		{
