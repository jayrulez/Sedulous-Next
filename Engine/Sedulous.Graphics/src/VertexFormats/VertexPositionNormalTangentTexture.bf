...
namespace Sedulous.Graphics.VertexFormats
{
	...
	public struct VertexPositionNormalTangentTexture
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionNormalTangentTexture" /> struct.
		/// </summary>
		...
		/// <summary>
		/// Initializes static members of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionNormalTangentTexture" /> struct.
		/// </summary>
		static this()
		{
