...
namespace Sedulous.Graphics.VertexFormats
{
	...
	public struct VertexPositionTexture
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionTexture" /> struct.
		/// </summary>
		...
		/// <summary>
		/// Initializes static members of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionTexture" /> struct.
		/// </summary>
		static this()
		{
