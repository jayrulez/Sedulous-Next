...
namespace Sedulous.Graphics.VertexFormats
{
	...
	public struct VertexPositionColorDualTexture
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionColorDualTexture" /> struct.
		/// </summary>
		...
		/// <summary>
		/// Initializes static members of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionColorDualTexture" /> struct.
		/// </summary>
		static this()
		{
