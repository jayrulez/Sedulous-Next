...
namespace Sedulous.Graphics.VertexFormats
{
	...
	public struct VertexPositionNormalDualTexture
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionNormalDualTexture" /> struct.
		/// </summary>
		...
		/// <summary>
		/// Initializes static members of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionNormalDualTexture" /> struct.
		/// </summary>
		static this()
		{
