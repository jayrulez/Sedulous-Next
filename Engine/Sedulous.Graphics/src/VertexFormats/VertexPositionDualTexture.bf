...
namespace Sedulous.Graphics.VertexFormats
{
	...
	public struct VertexPositionDualTexture
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionDualTexture" /> struct.
		/// </summary>
		...
		/// <summary>
		/// Initializes static members of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionDualTexture" /> struct.
		/// </summary>
		static this()
		{
