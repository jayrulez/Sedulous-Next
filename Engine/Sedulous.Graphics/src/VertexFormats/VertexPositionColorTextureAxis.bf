...
namespace Sedulous.Graphics.VertexFormats
{
	...
	public struct VertexPositionColorTextureAxis
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionColorTextureAxis" /> struct.
		/// </summary>
		...
		/// <summary>
		/// Initializes static members of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionColorTextureAxis" /> struct.
		/// </summary>
		static this()
		{
			VertexFormat = new LayoutDescription()
				...
				.Add(ElementDescription(ElementFormat.Float4, ElementSemanticType.TexCoord, 1u));
		}
