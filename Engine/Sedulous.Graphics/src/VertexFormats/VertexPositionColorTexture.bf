...
namespace Sedulous.Graphics.VertexFormats
{
	...
	public struct VertexPositionColorTexture
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionColorTexture" /> struct.
		/// </summary>
		...
		/// <summary>
		/// Initializes static members of the <see cref="T:Sedulous.Graphics.VertexFormats.VertexPositionColorTexture" /> struct.
		/// </summary>
		static this()
		{
