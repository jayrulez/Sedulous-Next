...
namespace Sedulous.Graphics
{
	...
	{
		/// <summary>
		/// Texture type <see cref="T:Sedulous.Graphics.TextureType" />.
		/// </summary>
		public TextureType Type;

		/// <summary>
		/// Texture format <see cref="T:Sedulous.Graphics.PixelFormat" />.
		/// </summary>
		...
		/// <summary>
		/// The texture flags  <see cref="T:Sedulous.Graphics.TextureFlags" />.
		/// </summary>
		...
		/// <summary>
		/// Flags <see cref="T:Sedulous.Graphics.ResourceCpuAccess" /> to specify the type of CPU access allowed.
		/// </summary>
		...
		{
			TextureDescription defaultValues = DefaultValues;
			defaultValues.Type = TextureType.Texture1D;
		...
		{
			TextureDescription defaultValues = DefaultValues;
			defaultValues.Type = TextureType.Texture2D;
			defaultValues.Width = width;
		...
		{
			TextureDescription defaultValues = DefaultValues;
			defaultValues.Type = TextureType.Texture3D;
			defaultValues.Width = width;
			defaultValues.Height = height;
			defaultValues.Depth = depth;
			defaultValues.Format = format;
			return defaultValues;
		}
		...
		{
			TextureDescription defaultValues = DefaultValues;
			defaultValues.Type = TextureType.TextureCube;
			defaultValues.Width = width;
			defaultValues.Height = height;
			defaultValues.Format = format;
			return defaultValues;
