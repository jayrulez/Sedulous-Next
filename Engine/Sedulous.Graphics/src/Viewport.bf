...
namespace Sedulous.Graphics
{
	...
	public struct Viewport : IEquatable<Viewport>
	{
		...
		/// </summary>
		public Rect Bounds => Rect((int32)X, (int32)Y, (int32)Width, (int32)Height);

		/// <summary>
		/// Initializes a new instance of the <see cref="T:Sedulous.Graphics.Viewport" /> struct.
		/// </summary>
		...
		/// <param name="minDepth">The minimun depth range.</param>
		/// <param name="maxDepth">The maximun depth range.</param>
		public this(Rect rectangle, float minDepth = 0f, float maxDepth = 1f)
		{
			X = rectangle.X;
			Y = rectangle.Y;
