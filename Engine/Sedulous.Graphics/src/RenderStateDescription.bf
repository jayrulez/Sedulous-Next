...
namespace Sedulous.Graphics
{
	...
	public struct RenderStateDescription : IEquatable<RenderStateDescription>
	{
		...
		public static RenderStateDescription Default
		{
			get
			{
				RenderStateDescription result = default(RenderStateDescription);
				result.SetDefault();
				return result;
			}
		}
		...
		{
			if (RasterizerState == other.RasterizerState && DepthStencilState == other.DepthStencilState && BlendState == other.BlendState && StencilReference == other.StencilReference && BlendFactor == other.BlendFactor)
			{
