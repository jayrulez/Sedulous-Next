...
{
	/// <summary>
	/// Default known values for <see cref="T:Sedulous.Graphics.BlendStateDescription" />.
	/// </summary>
	public static class BlendStates
	{
		...
		/// <summary>
		/// Initializes static members of the <see cref="T:Sedulous.Graphics.BlendStates" /> class.
		/// </summary>
		static this()
		{
