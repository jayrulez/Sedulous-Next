...
namespace Sedulous.Graphics
{
	...
	public struct DepthStencilStateDescription : IEquatable<DepthStencilStateDescription>
	{
		...
		{
			return (int32)(((((((((((uint32)(((DepthEnable.GetHashCode() * 397) ^ DepthWriteMask.GetHashCode()) * 397) ^ (uint32)DepthFunction) * 397) ^ (uint32)StencilEnable.GetHashCode()) * 397) ^ (uint32)StencilReadMask.GetHashCode()) * 397) ^ (uint32)StencilWriteMask.GetHashCode()) * 397) ^ (uint32)FrontFace.GetHashCode()) * 397) ^ BackFace.GetHashCode();
		}
