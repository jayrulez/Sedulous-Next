...
namespace Sedulous.Graphics
{
	...
	public struct ComputePipelineDescription : IEquatable<ComputePipelineDescription>
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Sedulous.Graphics.ComputePipelineDescription" /> struct.
		/// </summary>
		...
		public this(ResourceLayout[] resourceLayouts, ComputeShaderStateDescription shaderDescription, uint32 threadGroupSizeX = 1u, uint32 threadGroupSizeY = 1u, uint32 threadGroupSizeZ = 1u)
		{
		...
		{
			return (int32)((((((uint32)(((shaderDescription.GetHashCode() * 397) ^ ResourceLayouts.GetHashCode()) * 397) ^ ThreadGroupSizeX) * 397) ^ ThreadGroupSizeY) * 397) ^ ThreadGroupSizeZ);
		}
