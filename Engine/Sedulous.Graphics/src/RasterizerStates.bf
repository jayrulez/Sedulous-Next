...
{
	/// <summary>
	/// Default known values for <see cref="T:Sedulous.Graphics.RasterizerStateDescription" />.
	/// </summary>
	public static class RasterizerStates
	{
		...
		/// <summary>
		/// Initializes static members of the <see cref="T:Sedulous.Graphics.RasterizerStates" /> class.
		/// </summary>
		static this()
		{
