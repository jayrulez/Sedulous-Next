    ...
    internal static class VKFormats
    {
        internal static VkSamplerAddressMode VdToVkSamplerAddressMode(SamplerAddressMode mode)
        {
            switch (mode)
            {
                ...
                default:
				Runtime.FatalError(scope $"Illegal {typeof(SamplerAddressMode).GetName(.. scope .())}");
            }
        }
            ...
            out VkSamplerMipmapMode mipmapMode)
        {
            switch (filter)
            {
                ...
                case SamplerFilter.MinLinear_MagLinear_MipLinear:
                    ...
                    break;
                default:
				Runtime.FatalError(scope $"Illegal {typeof(SamplerFilter).GetName(.. scope .())}");
            }
        }
        ...
        internal static VkImageType VdToVkTextureType(TextureType type)
        {
            switch (type)
            {
                ...
                default:
				Runtime.FatalError(scope $"Illegal {typeof(TextureType).GetName(.. scope .())}");
            }
        }
        ...
        internal static VkDescriptorType VdToVkDescriptorType(ResourceKind kind, ResourceLayoutElementOptions options)
        {
            ...
            switch (kind)
            {
                ...
                case ResourceKind.StructuredBufferReadWrite: fallthrough;
                ...
                default:
				Runtime.FatalError(scope $"Illegal {typeof(ResourceKind).GetName(.. scope .())}");
            }
        }
        ...
        internal static VkStencilOp VdToVkStencilOp(StencilOperation op)
        {
            switch (op)
            {
                ...
                default:
				Runtime.FatalError(scope $"Illegal {typeof(StencilOperation).GetName(.. scope .())}");
            }
        }
        ...
        internal static VkPolygonMode VdToVkPolygonMode(PolygonFillMode fillMode)
        {
            switch (fillMode)
            {
                ...
                default:
				Runtime.FatalError(scope $"Illegal {typeof(PolygonFillMode).GetName(.. scope .())}");
            }
        }
        ...
        internal static VkCullModeFlags VdToVkCullMode(FaceCullMode cullMode)
        {
            switch (cullMode)
            {
                ...
                default:
				Runtime.FatalError(scope $"Illegal {typeof(FaceCullMode).GetName(.. scope .())}");
            }
        }
        ...
        internal static VkBlendOp VdToVkBlendOp(BlendFunction func)
        {
            switch (func)
            {
                ...
                default:
				Runtime.FatalError(scope $"Illegal {typeof(BlendFunction).GetName(.. scope .())}");
            }
        }
        ...
        internal static VkPrimitiveTopology VdToVkPrimitiveTopology(PrimitiveTopology topology)
        {
            switch (topology)
            {
                ...
                default:
				Runtime.FatalError(scope $"Illegal {typeof(PrimitiveTopology).GetName(.. scope .())}");
            }
        }
        ...
        internal static uint32 GetSpecializationConstantSize(ShaderConstantType type)
        {
            switch (type)
            {
                ...
                case ShaderConstantType.Double:
                    return 8;
                default:
				Runtime.FatalError(scope $"Illegal {typeof(ShaderConstantType).GetName(.. scope .())}");
            }
        }
        ...
        internal static VkBlendFactor VdToVkBlendFactor(BlendFactor factor)
        {
            switch (factor)
            {
                ...
                default:
				Runtime.FatalError(scope $"Illegal {typeof(BlendFactor).GetName(.. scope .())}");
            }
        }
        ...
        internal static VkBorderColor VdToVkSamplerBorderColor(SamplerBorderColor borderColor)
        {
            switch (borderColor)
            {
                ...
                default:
				Runtime.FatalError(scope $"Illegal {typeof(SamplerBorderColor).GetName(.. scope .())}");
            }
        }
        ...
        internal static VkIndexType VdToVkIndexFormat(IndexFormat format)
        {
            switch (format)
            {
                ...
                default:
				Runtime.FatalError(scope $"Illegal {typeof(IndexFormat).GetName(.. scope .())}");
            }
        }
        ...
        internal static VkCompareOp VdToVkCompareOp(ComparisonKind comparisonKind)
        {
            switch (comparisonKind)
            {
                ...
                default:
				Runtime.FatalError(scope $"Illegal {typeof(ComparisonKind).GetName(.. scope .())}");
            }
        }
        ...
        internal static PixelFormat VkToVdPixelFormat(VkFormat vkFormat)
        {
			...
			case VkFormat.VK_FORMAT_R32_SFLOAT: fallthrough;
			...
			case VkFormat.VK_FORMAT_R32G32B32A32_SFLOAT:
                ...
                default:
				Runtime.FatalError(scope $"Illegal {typeof(VkFormat).GetName(.. scope .())}");
            }
        }
    }
}
