...
namespace Sedulous.GAL.Vulkan
{
    ...
    internal  class VKFramebuffer : VKFramebufferBase
    {
        ...
        private readonly Bulkan.VkFramebuffer _deviceFramebuffer;
        ...
        public override Bulkan.VkFramebuffer CurrentFramebuffer => _deviceFramebuffer;
		...
		private readonly FramebufferDescription _description;

        public this(VKGraphicsDevice gd, FramebufferDescription description, bool isPresented)
            : base(description.DepthTarget, description.ColorTargets)
        {
            ...
            uint32 colorAttachmentCount = (uint32)ColorTargets.Length;
            ...
            subpassDependency.srcSubpass = VulkanNative.VK_SUBPASS_EXTERNAL;//SubpassExternal;
            ...
            VkFramebufferCreateInfo fbCI = VkFramebufferCreateInfo();
            ...
            for (int i = 0; i < colorAttachmentCount; i++)
            {
                ...
                VkImageViewCreateInfo imageViewCI = VkImageViewCreateInfo();
            ...
            if (description.DepthTarget != null)
            {
                ...
                VkImageViewCreateInfo depthViewCI = VkImageViewCreateInfo();
            ...
            AttachmentCount += (uint32)ColorTargets.Length;
        }
