...
namespace Sedulous.GAL.Vulkan
{
    ...
    internal  class VKShader : Shader
    {
        ...
        public this(VKGraphicsDevice gd, ShaderDescription description)
            : base(description.Stage, description.EntryPoint)
        {
            _gd = gd;

            VkShaderModuleCreateInfo shaderModuleCI = VkShaderModuleCreateInfo();
            shaderModuleCI.codeSize = (.)description.ShaderBytes.Length;
