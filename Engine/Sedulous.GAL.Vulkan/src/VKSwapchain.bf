...
namespace Sedulous.GAL.Vulkan
{
    ...
    internal  class VKSwapchain : Swapchain
    {
        ...
        private Bulkan.VkFence _imageAvailableFence;
        ...
        public Bulkan.VkFence ImageAvailableFence => _imageAvailableFence;
        ...
        public this(VKGraphicsDevice gd, ref SwapchainDescription description) : this(gd, ref description, VkSurfaceKHR.Null) { }
        ...
        public this(VKGraphicsDevice gd, ref SwapchainDescription description, VkSurfaceKHR existingSurface)
        {
            ...
            {
                Runtime.FatalError($"The system does not support presenting the given Vulkan surface.");
            }
        ...
        public bool AcquireNextImage(VkDevice device, VkSemaphore semaphore, Bulkan.VkFence fence)
        {
            ...
            {
                Runtime.FatalError("Could not acquire next image from the Vulkan swapchain.");
            }
        ...
        private bool CreateSwapchain(uint32 width, uint32 height)
        {
            ...
            {
                Runtime.FatalError($"The Swapchain's underlying surface has been lost.");
            }
            ...
            {
                surfaceFormat = VkSurfaceFormatKHR { colorSpace = VkColorSpaceKHR.VK_COLORSPACE_SRGB_NONLINEAR_KHR, format = desiredFormat };
            }
            else
            {
                ...
                if (surfaceFormat.format == VkFormat.VK_FORMAT_UNDEFINED)
                {
                    ...
                    {
                        Runtime.FatalError($"Unable to create an sRGB Swapchain for this surface.");
                    }
            ...
            VkSwapchainCreateInfoKHR swapchainCI = VkSwapchainCreateInfoKHR();
