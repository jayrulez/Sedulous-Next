...
namespace Sedulous.GAL.Vulkan
{
    ...
    internal  class VKTexture : Texture
    {
        ...
        private readonly Bulkan.VkBuffer _stagingBuffer;
        ...
        public Bulkan.VkBuffer StagingBuffer => _stagingBuffer;
        public VKMemoryBlock Memory => _memoryBlock;

        public VkFormat VkFormat { get; }
        public VkSampleCountFlags VkSampleCount { get; }

        private VkImageLayout[] _imageLayouts ~ delete _;
        ...
        internal this(VKGraphicsDevice gd, TextureDescription description)
        {
            _gd = gd;
            ...
            if (!isStaging)
            {
                VkImageCreateInfo imageCI = VkImageCreateInfo();
                ...
                {
                    VkImageMemoryRequirementsInfo2 memReqsInfo2 = VkImageMemoryRequirementsInfo2();
                    memReqsInfo2.image = _optimalImage;
                    VkMemoryRequirements2 memReqs2 = VkMemoryRequirements2();
                    VkMemoryDedicatedRequirements dedicatedReqs = VkMemoryDedicatedRequirements();
                ...
                for (int32 i = 0; i < _imageLayouts.Count; i++)
                {
            ...
            else // isStaging
            {
                ...
                VkBufferCreateInfo bufferCI = VkBufferCreateInfo();
                ...
                {
                    VkBufferMemoryRequirementsInfo2 memReqInfo2 = VkBufferMemoryRequirementsInfo2();
            ...
            VkImage existingImage)
        {
            ...
            _imageLayouts = new VkImageLayout[] ( VkImageLayout.VK_IMAGE_LAYOUT_UNDEFINED );
        ...
        private void ClearIfRenderTarget()
        {
            ...
            {
                _gd.ClearDepthTexture(this,  VkClearDepthStencilValue() {depth = 0, stencil = 0});
            }
        }
        ...
        {
            if (_stagingBuffer != Bulkan.VkBuffer.Null)
            {
                return;
            }
            ...
            for (uint32 level = 0; level < levelCount; level++)
            {
                for (uint32 layer = 0; layer < layerCount; layer++)
                {
                    ...
                    {
                        Runtime.FatalError("Unexpected image layout.");
                    }
                }
            }
#endif
        ...
        {
            Debug.Assert(_stagingBuffer != Bulkan.VkBuffer.Null);
        ...
        internal protected override void DisposeCore()
        {
            RefCount.Decrement();
        }
