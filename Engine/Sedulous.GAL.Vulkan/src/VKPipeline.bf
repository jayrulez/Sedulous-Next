...
namespace Sedulous.GAL.Vulkan
{
    ...
    internal  class VKPipeline : Pipeline
    {
        ...
        private readonly Bulkan.VkPipeline _devicePipeline;
        private readonly VkPipelineLayout _pipelineLayout;
        private readonly VkRenderPass _renderPass;
        private bool _destroyed;
        private String _name;

        public Bulkan.VkPipeline DevicePipeline => _devicePipeline;
        ...
        public this(VKGraphicsDevice gd, GraphicsPipelineDescription description)
            : base(description)
        {
            _gd = gd;
            ...
            VkGraphicsPipelineCreateInfo pipelineCI = VkGraphicsPipelineCreateInfo();

            // Blend State
            VkPipelineColorBlendStateCreateInfo blendStateCI = VkPipelineColorBlendStateCreateInfo();
            ...
            VkPipelineRasterizationStateCreateInfo rsCI = VkPipelineRasterizationStateCreateInfo();
            ...
            VkPipelineDepthStencilStateCreateInfo dssCI = VkPipelineDepthStencilStateCreateInfo();
            ...
            // Multisample
            VkPipelineMultisampleStateCreateInfo multisampleCI = VkPipelineMultisampleStateCreateInfo();
            ...
            for (int32 i = 0; i < inputDescriptions.Count; i++)
            {
            ...
            for (int32 binding = 0; binding < inputDescriptions.Count; binding++)
            {
                ...
                for (int32 location = 0; location < inputDesc.Elements.Count; location++)
                {
            ...
            for (Shader shader in shaders)
            {
                ...
                VkPipelineShaderStageCreateInfo stageCI = VkPipelineShaderStageCreateInfo();
                stageCI.module = vkShader.ShaderModule;
                stageCI.stage = VKFormats.VdToVkShaderStages(shader.Stage);
                stageCI.pName = shader.EntryPoint.CStr();
            ...
            // ViewportState
            VkPipelineViewportStateCreateInfo viewportStateCI = VkPipelineViewportStateCreateInfo();
            ...
            // Pipeline Layout
            Span<ResourceLayout> resourceLayouts = description.ResourceLayouts;
            VkPipelineLayoutCreateInfo pipelineLayoutCI = VkPipelineLayoutCreateInfo();
            pipelineLayoutCI.setLayoutCount = (uint32)resourceLayouts.Length;
            VkDescriptorSetLayout* dsls = scope VkDescriptorSetLayout[resourceLayouts.Length]*;
            ...
            VkRenderPassCreateInfo renderPassCI = VkRenderPassCreateInfo();
            OutputDescription outputDesc = description.Outputs;
            List<VkAttachmentDescription> attachments = scope List<VkAttachmentDescription>();

            // TODO: A huge portion of this next part is duplicated in VkFramebuffer.cs.

            List<VkAttachmentDescription> colorAttachmentDescs = scope List<VkAttachmentDescription>();
            List<VkAttachmentReference> colorAttachmentRefs = scope List<VkAttachmentReference>();
        ...
        public this(VKGraphicsDevice gd, ComputePipelineDescription description)
            : base(description)
        {
            _gd = gd;
            ...
            VkComputePipelineCreateInfo pipelineCI = VkComputePipelineCreateInfo();
