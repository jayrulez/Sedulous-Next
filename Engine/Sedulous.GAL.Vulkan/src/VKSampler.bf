...
namespace Sedulous.GAL.Vulkan
{
    ...
    internal  class VKSampler : Sampler
    {
        ...
        private readonly Bulkan.VkSampler _sampler;
        private bool _disposed;
        private String _name;

        public Bulkan.VkSampler DeviceSampler => _sampler;

        public ResourceRefCount RefCount { get; } ~ delete _;

        public override bool IsDisposed => _disposed;

        public this(VKGraphicsDevice gd, SamplerDescription description)
        {
            _gd = gd;
