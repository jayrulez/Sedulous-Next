...
namespace Sedulous.RHI.Vulkan
{
	class CommandQueueVK : CommandQueue
	{
		...
		public override void Submit(in WorkSubmissionDesc workSubmissionDesc, DeviceSemaphore deviceSemaphore)
		{
			...
			readonly VkResult result = vkQueueSubmit(m_Handle, 1, &submission, fence);
		...
		public override void Wait(ref DeviceSemaphore deviceSemaphore)
		{
			...
			VkResult result = vkWaitForFences(m_Device, 1, &fence, VulkanNative.VK_TRUE, tenSeconds);
		...
		{
			VkResult result = vkQueueWaitIdle(m_Handle);
